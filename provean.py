...
if __name__=='__main__': 
    ...
    parser.add_argument('-s', '--outseq_dir', metavar="DIRNAME", dest='seqdir', required=True, help='Required: Name of output directory to store aa sequence.')
    parser.add_argument('-v', '--outvar_dir', metavar="DIRNAME", dest='vardir', required=True, help='Required: Name of output directory to store aa variations.')
